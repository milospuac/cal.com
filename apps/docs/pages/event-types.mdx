...
2. Under `Event Name`, enter your desired name that you want to be shown in Cal and your integrated calendars. If you want the name of the booker to be pulled in the name of the event, just follow this form: `anything-here {USER}`. Make sure that the USER is in all capital letters. For example, if you confirmed a meeting with John Doe and in the Event Name of that Event Type you wrote `Meeting with {USER}`, the event name in all calendars will be `Meeting with John Doe`
